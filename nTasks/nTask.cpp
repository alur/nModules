...
LRESULT WINAPI LSMessageHandler(HWND window, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case LM_TASKMARKASACTIVE:
    case LM_TASKREGISTERTAB:
    case LM_TASKUNREGISTERTAB:
    case LM_TASKSETACTIVETAB:
    case LM_TASKSETTABORDER:
    case LM_TASKSETTABPROPERTIES:
    case LM_TASKSETOVERLAYICON:
    case LM_TASKSETOVERLAYICONDESC:
    case LM_TASKSETTHUMBNAILTOOLTIP:
    case LM_TASKSETTHUMBNAILCLIP:
    case LM_TASKADDBUTTONS:
    case LM_TASKUPDATEBUTTONS:
    case LM_TASKSETIMAGELIST:
        {
        }
        return WindowManager::ShellMessage(window, message, wParam, lParam);
    }
