...
Gdiplus::ARGB (__cdecl * _pGetPrefixedRCColor)(LPCSTR, LPCSTR, int);
...
HRESULT nCore::InputParsing::Init(HMODULE hCoreInstance) {
	...
	INIT_FUNC(_pGetPrefixedRCColor,Gdiplus::ARGB (__cdecl *)(LPCSTR, LPCSTR, int),"GetPrefixedRCColor")
...
Gdiplus::ARGB nCore::InputParsing::GetPrefixedRCColor(LPCSTR szPrefix, LPCSTR szOption, int nDefault) {
